...
A second setting, **Will Camo Wash Off in Water** (a checkbox, on by default, shared by all clients), makes a player's camouflage wash off the moment they dive underwater, returning their original face. Swimming on the surface doesn't wash it off, and only player-controlled units are affected; AI keep their camo until it's removed. Turn it off to let camo survive diving, for example in naval missions.

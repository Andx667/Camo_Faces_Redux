...
| `fnc_washOff` | `[unit]` | Washes camo off a swimming or diving unit if **Will Camo Wash Off in Water** is on; called about once a second on the local player |
